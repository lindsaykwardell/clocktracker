const roles = [
  ...
  },
  {
    ...
    otherNightReminder:
      "If the dead outnumber the living, show the character token of an alive player.",
    reminders: [],
    setup: false,
    ability:
  ...
  },
  {
    ...
    reminders: ["Seen Townsfolk", "Seen Outsider", "Seen Minion", "Seen Demon"],
    setup: true,
    ability:
  ...
  },
  {
    ...
    jinxes: [
      ...
      },
      {
        id: "marionette",
        reason:
          "If the Kazali chooses to create a Marionette, they must choose one of their neighbours.",
      },
      {
        id: "huntsman",
        reason:
...
for (const role of roles) {
  if (role.reminders) {
    for (reminder of role.reminders) {
      reminders.push({
        role_id: role.name.toLowerCase().replace(/ /g, "_").replace(/'/g, ""),
        reminder,
      });
    }
  }
