<template>
  <div class="w-full h-64">
    <h2 class="font-sorts text-center text-xl lg:text-2xl mb-1 lg:mb-2">
      Storytold Games & Balance
    </h2>
    
    <div class="text-center text-balance max-w-[80ch] mb-2 lg:mb-4 mx-auto text-stone-800 dark:text-stone-300 space-y-2">
      <p>
        An overview of {{ props.isMe ? 'your' : `this storyteller's` }} games and balance evolution (Good vs Evil) in the past 12 months.
      </p>
    </div>
...
/**
 * Storyteller games for this user within the last 12 months.
 */
const storytellerGames = computed(() =>
  filterStorytellerGames(props.games, props.username).filter((game) =>
...
/**
 * Monthly storyteller outcomes (good/evil wins).
 */
