<template>
    ...
    <nav id="sidebar" :class="showMenu ? 'closed' : 'open'">
        <ul>
            <li>
                <div class="logo">
                    <nuxt-link to="/" title="Home">
                        <ImageUI
                            image="logo-ct"
                            class="logo-ct w-[48px] min-w-[48px!important]"
                        />
                    </nuxt-link>
            ...
            <li>
                <NavLink id="dashboard" to="/" icon="innkeeper" title="Home">
                    Home
                </NavLink>
            </li>
        ...
        <ul class="sidebar-bottom">
            <template v-if="me.status === Status.SUCCESS">
                ...
                <li>
                    <NavLink to="/logout" icon="vigormortis" title="Logout">
                        Logout
                    </NavLink>
                </li>
            </template>
            <template v-else>
                <NavLink to="/login" icon="ravenkeeper" title="Login">
                    Login
                </NavLink>
            </template>
